 ...
 */
package org.h819.commons.file.pdf.itext.examples;
...
public class OptionalContentActionExample {
	...
	/** The resulting PDF. */
	public static String RESULT = "d://1_actions.pdf";
	...
	public void createPdf(String filename) throws DocumentException,
		...
		cb.showTextAligned(Element.ALIGN_LEFT,
				"Q1: Who is the director of the movie 'Paths of Glory'?", 50,
				766, 0);
		cb.showTextAligned(Element.ALIGN_LEFT,
				"Q2: Who directed the movie 'Lawrence of Arabia'?", 50, 718, 0);
		cb.showTextAligned(Element.ALIGN_LEFT,
				"Q3: Who is the director of 'House of Flying Daggers'?", 50,
				670, 0);
		cb.endText();
		cb.saveState();
		...
		cb.beginText();
		cb.beginLayer(a1);
		cb.showTextAligned(Element.ALIGN_LEFT, "A1: Stanley Kubrick", 50, 742,
				0);
		cb.endLayer();
		cb.beginLayer(a2);
		cb.showTextAligned(Element.ALIGN_LEFT, "A2: David Lean", 50, 694, 0);
		cb.endLayer();
		cb.beginLayer(a3);
		cb.showTextAligned(Element.ALIGN_LEFT, "A3: Zhang Yimou", 50, 646, 0);
		cb.endLayer();
		cb.endText();
		cb.restoreState();
