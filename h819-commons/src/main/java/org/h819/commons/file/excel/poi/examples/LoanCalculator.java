...
public class LoanCalculator {
	...
	public static void main(String[] args) throws Exception {
		...
		cell = row.createCell(4);
		cell
				.setCellFormula("IF(Values_Entered,Monthly_Payment*Number_of_Payments,\"\")");
		cell.setCellStyle(styles.get("formula_$"));
	...
	public static void createNames(Workbook wb) {
		...
		name
				.setRefersToFormula("-PMT(Interest_Rate/12,Number_of_Payments,Loan_Amount)");
		...
		name
				.setRefersToFormula("IF(Loan_Amount*Interest_Rate*Loan_Years*Loan_Start>0,1,0)");
	}
}