...
public class JdbcSearchFilter {
     ...
     * @param value
     */
    public JdbcSearchFilter(String tableName, String fieldName, Operator operator, Object value) {
     ...
     * @param betweenTo
     */
    public JdbcSearchFilter(String fieldName, Operator operator, Object betweenFrom, Object betweenTo) {
