...
public class JqgridLogBackController {
    ...
    private static Logger logger = LoggerFactory.getLogger(JqgridLogBackController.class);
    ...
    public String jqgridWebSiteSearchJsonData(
        ...
        Specification specification = DynamicSpecificationUtils.bySearchFilter(
        ...
        Page<LoggingEventEntity> list = JqgridJPAUtils.getJqgridResponse(loggingEventEntityRepository, page, rows, sidx, sord, filters, specification);
