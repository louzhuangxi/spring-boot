...
<script type="text/javascript">
	var scripts = [null, "${contextPath}/static/assets/js/morris/raphael.min.js", "${contextPath}/static/assets/js/morris/morris.min.js", "${contextPath}/static/assets/js/morris/morris-data.js", "${contextPath}/static/assets/js/flot/jquery.flot.js", "${contextPath}/static/assets/js/flot/jquery.flot.tooltip.min.js", "${contextPath}/static/assets/js/flot/jquery.flot.resize.js", "${contextPath}/static/assets/js/flot/jquery.flot.pie.js", "${contextPath}/static/assets/js/flot/flot-data.js", null]
