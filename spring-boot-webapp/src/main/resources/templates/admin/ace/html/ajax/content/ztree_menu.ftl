                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="row">
                                        ...
                                        <hr/>
                                        <h4 class="header smaller lighter info"><i class="ace-icon fa fa-sitemap"></i>
                                            树结构编辑 </h4>
                                        <p><a id="addLeaf" href="###" title="增加叶节点" onClick="return false;">
                                            <button class="btn btn-white btn-success btn-round"><i
                                                    class="ace-icon fa fa-leaf bigger-120 green"></i> 增加叶节点
                                            </button>
                                        ...
                                        <p><a id="copy" href="###" title="复制" onClick="return false;">
                                            <button class="btn btn-white btn-default btn-round"><i
                                                    class="ace-icon fa fa-files-o bigger-110"></i> 复制
                                            </button>
                                        </a> <a id="cut" href="###" title="剪切" onClick="return false;">
                                            <button class="btn btn-white btn-default btn-round"><i
                                                    class="ace-icon fa fa-scissors bigger-110 "></i> 剪切
                                            </button>
                                        </a> <a id="paste" href="###" title="粘贴" onClick="return false;">
                                            <button class="btn btn-white btn-default btn-round"><i
                                                    class="ace-icon fa fa-clipboard bigger-110"></i> 粘贴
                                            </button>
                                        </a></p>
                                        <hr/>
                                        <h4 class="header smaller lighter blue"><i class="ace-icon fa fa-share-alt"></i>
                                            导航菜单编辑 </h4>
                                        <p>
                                            <button id="menu-css" class="btn btn-white btn-default btn-round"><i
                                                    class="ace-icon fa fa-info bigger-110"></i> 菜单 CSS
                                            </button>
                                            <button id="menu-url" class="btn btn-white btn-default btn-round"><i
                                                    class="ace-icon fa fa-link bigger-110 "></i> 菜单 URL
                                            </button>
                                        </p>
                                        <hr/>
                                        <h4 class="header smaller lighter green"><i
                                                class="ace-icon fa fa-object-group"></i> 节点关联对象 </h4>
                                        <p>
                                            <button id="standard-link" class="btn btn-white btn-default btn-round"><i
                                                    class="ace-icon fa fa-files-o bigger-110"></i> 节点关联标准
                                            </button>

                                        </p>
                                        <hr/>
                                        <h4 class="header smaller lighter red"><i class="ace-icon fa fa-bullhorn"></i>
                                            控制台 </h4>
