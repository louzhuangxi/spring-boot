...
public class PrivilegeEntity extends BaseEntity {
    ...
    private Collection<TreeNodeEntity> treeNodes = new HashSet<TreeNodeEntity>();
    ...
    public Collection<TreeNodeEntity> getTreeNodes() {
        return treeNodes;
    }

    public void setTreeNodes(Collection<TreeNodeEntity> treeNodes) {
